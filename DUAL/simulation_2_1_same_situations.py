...
# DEFINES Simulation 2.1. Recognition among similar base situations.
# NOTE: THE SIMULATION IS A 1:1 REPLICATION OF Simulation_1_2.
...
# END of file: simulation_2_1_same_situations.py #          
