...
# DEFINES Simulation 2_3: Recognition or creation of new relation-based concepts among:
# slightly different base situations and mixed target.
...
relation-based concepts through slightly different base situations and mixed target:
 	The grandmother feeds the chicken. - as base episode
	The neighbour milks the cow.       - as target 1/base episode 2
	The neighbour feeds the horse.     - as target 2
"""
...
def load_kb_2():
    #TARGET EPISODE 2
    add_agent("neighbour_3", agent_type=InstanceAgent, instance_of=[find_agent("neighbour")])
    ...
    add_agent("feeds_3", agent_type=RelationInstanceAgent, arity=2,
              arguments=[find_agent("neighbour_3"), find_agent("horse_3")],
              instance_of=[find_agent("feeds")])


# END of file: simulation_2_3_diff_Bases_mixed_Target.py #
